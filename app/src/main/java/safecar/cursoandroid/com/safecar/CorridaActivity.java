...
import safecar.cursoandroid.com.safecar.helper.Local;
...
public class CorridaActivity extends AppCompatActivity
    ...
    private ImageView abrirAvaliacao;
    ...
    private void iniciarMonitoramento(final Usuario uOrigem, LatLng localDestino, final String status){
        ...
        //Adiciona cÃ­rculo no passageiro
        ...
        geoQuery.addGeoQueryEventListener(new GeoQueryEventListener() {
            ...
            public void onKeyEntered(String key, GeoLocation location) {
                ...
                if( key.equals(uOrigem.getId()) ){
                    //Log.d("onKeyEntered", "onKeyEntered: motorista estÃ¡ dentro da Ã¡rea!");
    ...
    private void recuperarLocalizacaoUsuario() {
        ...
        locationListener = new LocationListener() {
            ...
            public void onLocationChanged(Location location) {
                ...
                //Atualizar localizaÃ§Ã£o motorista no Firebase
    ...
    private void inicializarComponentes(){
        ...
        abrirSeguranca = findViewById(R.id.abrirSeguranca);
        abrirAvaliacao = findViewById(R.id.abrirAvaliacao);
        ...
        abrirSeguranca.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(CorridaActivity.this, TrajetoActivity.class);
                startActivity(i);
            }
        });

        abrirAvaliacao.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(CorridaActivity.this, AvaliacaoActivity.class));
            }
        });
